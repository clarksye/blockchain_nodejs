...
describe('Blockchain', () => {
        ...
        describe('when the chain starts with the genesis block and has muliple blocks', () => {
            ...
            describe('and the chain contains a block with a jumped difficulty', () => {
                it('returns false', () => {
                    ...
                    const data = [];
                    const hash = cryptoHash(timestamp, nonce, difficulty, lastHash, data);
    ...
    describe('replaceChain()', () => {
        ...
        describe('and the `validatedTransactions` flag is true', () => {
            it('calls validTransactionData()', () => {
                const validTransactionData = jest.fn();

                blockchain.validTransactionData = validTransactionData;

                newChain.addBlock({ data: 'foo' });
                blockchain.replaceChain(newChain.chain, true);

                expect(validTransactionData).toHaveBeenCalled();
            });
        });
    });
